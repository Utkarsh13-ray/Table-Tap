...
const login = () => {
  ...
  return (
    ...
    <section className="h-screen bg-slate-50 flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
      ...
      <div className="container rounded overflow-hidden shadow-2xl p-14  max-w-sm">
        <div className="text-center md:text-left">
          <label className="mr-1">Sign in with</label>
          <button
            type="button"
            className="mx-1 h-9 w-9 rounded-full bg-highlight hover:bg-[#066163] text-white shadow-[0_4px_9px_-4px_#3b71ca]"
          >
            <svg
