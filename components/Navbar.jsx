    ...
    <div className="hidden lg:flex lg:items-center text-white lg:w-auto w-full" id="menu">
      <nav>
        <ul className="lg:flex items-center justify-between text-sm font-medium  pt-4 lg:pt-0">
          <li><a className="lg:p-4 py-3 px-0 block border-b-2 border-transparent  hover:text-gray-900" href="#">Dashboard</a></li>
          <li><a className="lg:p-4 py-3 px-0 block border-b-2 border-transparent  hover:text-gray-900" href="#">Courses</a></li>
          <li><a className="lg:p-4 py-3 px-0 block border-b-2 border-transparent  hover:text-gray-900" href="#">Users</a></li>
          <li><a className="lg:p-4 py-3 px-0 block border-b-2 border-transparent  hover:text-gray-900 lg:mb-0 mb-2" href="#">Support</a></li>
        </ul>
      </nav>
      <a href="#" className="lg:ml-4 flex items-center justify-start lg:mb-0 mb-4 pointer-cursor" id="userdropdown">
      <img className="rounded-full w-10 h-10 border-2 border-transparent hover:border-pink-400 ignore-body-click" src="" alt="avatar"/>
    </a>
